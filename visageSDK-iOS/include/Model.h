...
//////////////////////////////////////////////////////////////////////
	...
	public:
		...
		void tryGlobalParameters(IplImage* image);
...
//		inline Vertex& meanImageCoord( int v ) { return _imageMeanCoords[v]; }
		...
		/// Returns a face (surface, triangle) of the model.
	...
	//////////////////////////////////////////////////////////////////
		...
		/// Recalculates (if necessary) the static shape of the model.
		bool       updateStatic();

		/// \brief Recalculates (if necessary) the dynamic (animated) shape of the model.
		///
		...
		//void       updateImageMeanCoords(const Projection& proj = WeakPerspective());
		...
		void       rotate             (const Vertex& dr);     ///< Rotate the model.
		void       scale              (const Vertex& ds);     ///< Scale the model.
		void       translate          (const Vertex& dt);     ///< Translate the model.
		void       rotate             (double dx, double dy, double dz); ///< Rotate the model.
		void       scale              (double dx, double dy, double dz); ///< Scale the model.
		void       translate          (double dx, double dy, double dz); ///< Translate the model.
		void       scale              (double ds);                       ///< Scale the model.
		...
		/// \brief Draw the model on an image.
		///
		/// updateImageCoords() should be called first.
		///
